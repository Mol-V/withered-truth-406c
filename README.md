...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/withered-truth-406c
```

A live public deployment of this template is available at [https://withered-truth-406c.templates.workers.dev](https://withered-truth-406c.templates.workers.dev)
